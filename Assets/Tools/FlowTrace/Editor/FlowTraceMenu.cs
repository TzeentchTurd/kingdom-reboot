...
namespace FlowTraceEditor
{
    public static class FlowTraceMenu
    {
        ...
        public static void RunBattleSmoke()
        {
            ...
            EnsureScene(battlePrefab, eventPrefab);
        ...
        private static void EnsureScene(GameObject battlePrefab, GameObject eventPrefab)
        {
            // If scene exists, ensure it has required objects and references
            if (File.Exists(ScenePath))
            {
                var scene = EditorSceneManager.OpenScene(ScenePath, OpenSceneMode.Single);
                EnsureSceneObjects(scene, battlePrefab, eventPrefab);
            ...
            EnsureSceneObjects(newScene, battlePrefab, eventPrefab);
            EditorSceneManager.SaveScene(newScene, ScenePath);
            AssetDatabase.SaveAssets();
        }

        private static void EnsureSceneObjects(Scene scene, GameObject battlePrefab, GameObject eventPrefab)
        {
